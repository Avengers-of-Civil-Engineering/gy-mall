...
const routes = [
  ...
  },
  {
    ...
    component: () => import(/* webpackChunkName: "ordersConfirmation" */ '@/views/orderConfirmation/OrdersConfirmation.vue')
  },
  {
    path: '/cartList',
    name: 'CartList',
  ...
  },
  {
    ...
    name: 'OrderInfo',
    // component: OrderInfo,
    component: () => import(/* webpackChunkName: "orderInfo" */ '@/views/orderList/OrderInfo.vue')
  },
  {
    path: '/mine',
    name: 'Mine',
